...
namespace API.Controllers
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordDto forgotPasswordDto)
        {
            ...
            //var client = new RestClient("https://send.api.mailtrap.io/api/send");
            //var request = new RestRequest();
            //request.AddHeader("Authorization", "Bearer 4d136ae1a8f4d9ac8cbe772eda76ccb2");
            //request.AddHeader("Content-Type", "application/json");
            //request.AddParameter("application/json", "{\"from\":{\"email\":\"mailtrap@demomailtrap.com\",\"name\":\"Mailtrap Test\"},\"to\":[{\"email\":\"steamngfx@gmail.com\"}],\"template_uuid\":\"1253fe15-f262-4378-b4a3-946a72fe4452\",\"template_variables\":{\"user_email\":\"Test_User_email\",\"pass_reset_link\":\"Test_Pass_reset_link\"}}", ParameterType.RequestBody);
            ...
            request.AddJsonBody(new
            {
                ...
                to = new[] { new { email = "steamngfx@gmail.com" } },
                template_uuid = "1253fe15-f262-4378-b4a3-946a72fe4452",
